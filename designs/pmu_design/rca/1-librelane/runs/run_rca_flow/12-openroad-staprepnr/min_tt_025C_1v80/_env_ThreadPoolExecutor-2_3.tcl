...
set ::env(CURRENT_NETLIST) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/06-yosys-synthesis/rca.nl.v
set ::env(SAVE_SDC) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/12-openroad-staprepnr/rca.sdc
