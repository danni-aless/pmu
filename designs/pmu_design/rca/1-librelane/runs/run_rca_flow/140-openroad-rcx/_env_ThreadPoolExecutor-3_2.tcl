...
set ::env(CURRENT_DEF) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/139-odb-cellfrequencytables/rca.def
...
set ::env(SAVE_SPEF) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/140-openroad-rcx/max/rca.max.spef
