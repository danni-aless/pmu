...
set ::env(CURRENT_ODB) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/128-openroad-repairantennas/1-diodeinsertion/rca.odb
set ::env(SAVE_ODB) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/130-openroad-detailedrouting/rca.odb
set ::env(SAVE_DEF) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/130-openroad-detailedrouting/rca.def
set ::env(SAVE_SDC) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/130-openroad-detailedrouting/rca.sdc
set ::env(SAVE_NETLIST) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/130-openroad-detailedrouting/rca.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/130-openroad-detailedrouting/rca.pnl.v
