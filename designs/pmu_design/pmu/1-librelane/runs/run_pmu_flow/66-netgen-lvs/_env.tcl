...
set ::env(CURRENT_SPICE) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/64-magic-spiceextraction/pmu.spice
set ::env(CURRENT_POWERED_NETLIST) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/49-openroad-fillinsertion/pmu.pnl.v
