set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/13-openroad-floorplan/config.tracks
...
set ::env(DESIGN_NAME) pmu
set ::env(CLOCK_PERIOD) 10
set ::env(CLOCK_PORT) clk
set ::env(FALLBACK_SDC_FILE) /foss/designs/pmu_design/pmu/1-librelane/pmu.sdc
...
set ::env(CURRENT_NETLIST) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/06-yosys-synthesis/pmu.nl.v
set ::env(SAVE_ODB) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/13-openroad-floorplan/pmu.odb
set ::env(SAVE_DEF) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/13-openroad-floorplan/pmu.def
set ::env(SAVE_SDC) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/13-openroad-floorplan/pmu.sdc
set ::env(SAVE_NETLIST) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/13-openroad-floorplan/pmu.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/13-openroad-floorplan/pmu.pnl.v
