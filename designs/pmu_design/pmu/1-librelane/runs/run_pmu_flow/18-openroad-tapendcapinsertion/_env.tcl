...
set ::env(CURRENT_ODB) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/17-openroad-cutrows/pmu.odb
set ::env(SAVE_ODB) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/18-openroad-tapendcapinsertion/pmu.odb
set ::env(SAVE_DEF) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/18-openroad-tapendcapinsertion/pmu.def
set ::env(SAVE_SDC) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/18-openroad-tapendcapinsertion/pmu.sdc
set ::env(SAVE_NETLIST) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/18-openroad-tapendcapinsertion/pmu.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/18-openroad-tapendcapinsertion/pmu.pnl.v
