...
set ::env(CURRENT_ODB) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/32-openroad-detailedplacement/pmu.odb
set ::env(SAVE_ODB) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/33-openroad-cts/pmu.odb
set ::env(SAVE_DEF) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/33-openroad-cts/pmu.def
set ::env(SAVE_SDC) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/33-openroad-cts/pmu.sdc
set ::env(SAVE_NETLIST) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/33-openroad-cts/pmu.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/33-openroad-cts/pmu.pnl.v
