...
set ::env(CURRENT_NETLIST) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/64-openroad-fillinsertion/rca.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/66-openroad-rcx/nom/rca.nom.spef \"min_*\" /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/66-openroad-rcx/min/rca.min.spef \"max_*\" /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/66-openroad-rcx/max/rca.max.spef"
set ::env(CURRENT_ODB) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/65-odb-cellfrequencytables/rca.odb
set ::env(SAVE_SDC) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/67-openroad-stapostpnr/rca.sdc
