set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/100-openroad-floorplan/config.tracks
...
set ::env(CURRENT_NETLIST) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/93-yosys-synthesis/rca.nl.v
set ::env(SAVE_ODB) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/100-openroad-floorplan/rca.odb
set ::env(SAVE_DEF) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/100-openroad-floorplan/rca.def
set ::env(SAVE_SDC) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/100-openroad-floorplan/rca.sdc
set ::env(SAVE_NETLIST) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/100-openroad-floorplan/rca.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/100-openroad-floorplan/rca.pnl.v
