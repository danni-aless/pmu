...
set ::env(CURRENT_SPICE) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/79-magic-spiceextraction/rca.spice
set ::env(CURRENT_POWERED_NETLIST) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/64-openroad-fillinsertion/rca.pnl.v
