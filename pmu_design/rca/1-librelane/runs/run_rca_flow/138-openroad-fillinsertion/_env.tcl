...
set ::env(CURRENT_ODB) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/134-odb-reportdisconnectedpins/rca.odb
set ::env(SAVE_ODB) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/138-openroad-fillinsertion/rca.odb
set ::env(SAVE_DEF) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/138-openroad-fillinsertion/rca.def
set ::env(SAVE_SDC) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/138-openroad-fillinsertion/rca.sdc
set ::env(SAVE_NETLIST) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/138-openroad-fillinsertion/rca.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/138-openroad-fillinsertion/rca.pnl.v
