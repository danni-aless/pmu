...
set ::env(CURRENT_SPICE) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/153-magic-spiceextraction/rca.spice
set ::env(CURRENT_POWERED_NETLIST) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/138-openroad-fillinsertion/rca.pnl.v
