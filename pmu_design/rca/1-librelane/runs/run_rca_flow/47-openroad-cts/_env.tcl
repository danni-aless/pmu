...
set ::env(CURRENT_ODB) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/46-openroad-detailedplacement/rca.odb
set ::env(SAVE_ODB) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/47-openroad-cts/rca.odb
set ::env(SAVE_DEF) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/47-openroad-cts/rca.def
set ::env(SAVE_SDC) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/47-openroad-cts/rca.sdc
set ::env(SAVE_NETLIST) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/47-openroad-cts/rca.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/47-openroad-cts/rca.pnl.v
