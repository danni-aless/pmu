...
set ::env(CURRENT_ODB) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/105-openroad-tapendcapinsertion/rca.odb
set ::env(SAVE_ODB) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/107-openroad-generatepdn/rca.odb
set ::env(SAVE_DEF) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/107-openroad-generatepdn/rca.def
set ::env(SAVE_SDC) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/107-openroad-generatepdn/rca.sdc
set ::env(SAVE_NETLIST) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/107-openroad-generatepdn/rca.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/pmu_design/rca/1-librelane/runs/run_rca_flow/107-openroad-generatepdn/rca.pnl.v
