...
set ::env(CURRENT_NETLIST) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/49-openroad-fillinsertion/pmu.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/51-openroad-rcx/nom/pmu.nom.spef \"min_*\" /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/51-openroad-rcx/min/pmu.min.spef \"max_*\" /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/51-openroad-rcx/max/pmu.max.spef"
set ::env(CURRENT_ODB) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/50-odb-cellfrequencytables/pmu.odb
set ::env(SAVE_SDC) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/52-openroad-stapostpnr/pmu.sdc
