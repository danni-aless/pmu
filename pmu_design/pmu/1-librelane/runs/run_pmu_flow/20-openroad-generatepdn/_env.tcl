...
set ::env(CURRENT_ODB) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/18-openroad-tapendcapinsertion/pmu.odb
set ::env(SAVE_ODB) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/20-openroad-generatepdn/pmu.odb
set ::env(SAVE_DEF) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/20-openroad-generatepdn/pmu.def
set ::env(SAVE_SDC) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/20-openroad-generatepdn/pmu.sdc
set ::env(SAVE_NETLIST) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/20-openroad-generatepdn/pmu.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/20-openroad-generatepdn/pmu.pnl.v
