...
set ::env(CURRENT_ODB) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/33-openroad-cts/pmu.odb
set ::env(SAVE_ODB) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/36-openroad-globalrouting/pmu.odb
set ::env(SAVE_DEF) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/36-openroad-globalrouting/pmu.def
