...
set ::env(CURRENT_ODB) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/39-openroad-repairantennas/1-diodeinsertion/pmu.odb
set ::env(SAVE_ODB) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/41-openroad-detailedrouting/pmu.odb
set ::env(SAVE_DEF) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/41-openroad-detailedrouting/pmu.def
set ::env(SAVE_SDC) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/41-openroad-detailedrouting/pmu.sdc
set ::env(SAVE_NETLIST) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/41-openroad-detailedrouting/pmu.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/41-openroad-detailedrouting/pmu.pnl.v
