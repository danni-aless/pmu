...
set ::env(CURRENT_DEF) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/50-odb-cellfrequencytables/pmu.def
...
set ::env(SAVE_SPEF) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/51-openroad-rcx/min/pmu.min.spef
