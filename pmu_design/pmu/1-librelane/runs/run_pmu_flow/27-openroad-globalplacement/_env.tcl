...
set ::env(CURRENT_ODB) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/25-odb-customioplacement/pmu.odb
set ::env(SAVE_ODB) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/27-openroad-globalplacement/pmu.odb
set ::env(SAVE_DEF) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/27-openroad-globalplacement/pmu.def
set ::env(SAVE_SDC) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/27-openroad-globalplacement/pmu.sdc
set ::env(SAVE_NETLIST) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/27-openroad-globalplacement/pmu.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/pmu_design/pmu/1-librelane/runs/run_pmu_flow/27-openroad-globalplacement/pmu.pnl.v
