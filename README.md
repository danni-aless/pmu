...
4. Run the setup script (`setup_windows.bat` for Windows or `setup_linux.sh` for Linux) inside the PMU repository folder.

5. Wait until the Docker container opens.
